...
# Keep NaN values to visualize shutdown period in time series
key_cols = [
    '% Silica Concentrate',
    '% Silica Feed',
    'Starch Flow',
...
# layout=(-1, 1) stacks subplots vertically
...
# Transform wide format to long format for seaborn boxplot
...
# Slice one week for intra-day pattern analysis
